...
while {true} do
{
	...
	if(Z_TextHud)then{		
		(_display displayCtrl 3400)ctrlSetText format["FPS: %1 | JOGADORES: %2 | DANO: %3 | KRYPTO: %4 | FOME: %5 | SEDE: %6 | GPS: %7 ", round diag_fps, count playableUnits, damage player, EPOCH_playerCrypto, EPOCH_playerHunger, EPOCH_playerThirst, mapGridPosition player];
	}else{
