...
if (isnil "IL_Variables") then
{
	...
	// Supported vehicles
	IL_Supported_Vehicles_OFFROAD = ["O_G_Offroad_01_F", "C_Offroad_01_F", "B_G_Offroad_01_F", "B_mas_mar_Offroad_01_F","C_Offroad_01_EPOCH"];
	...
	IL_Supported_Vehicles_HEMTT = ["B_Truck_01_covered_F", "B_Truck_01_transport_F", "B_Truck_01_box_F", "B_Truck_01_transport_EPOCH", "B_Truck_01_covered_EPOCH"];
	IL_Supported_Vehicles_KAMAZ = ["I_Truck_02_transport_F", "O_Truck_02_transport_F", "I_Truck_02_covered_F", "O_Truck_02_covered_F", "O_Truck_02_covered_EPOCH", "O_Truck_02_transport_EPOCH"];
	IL_Supported_Vehicles_TEMPEST = ["O_Truck_03_transport_F", "O_Truck_03_covered_F", "O_Truck_03_covered_EPOCH", "O_Truck_02_box_EPOCH"];
	IL_Supported_Vehicles_MOHAWK = ["I_Heli_Transport_02_F", "CH49_Mohawk_FG", "I_Heli_Transport_02_EPOCH","I_Heli_light_03_unarmed_EPOCH", "O_Heli_Light_02_unarmed_EPOCH", "O_Heli_Transport_04_EPOCH", "O_Heli_Transport_04_bench_EPOCH", "O_Heli_Transport_04_box_EPOCH", "O_Heli_Transport_04_covered_EPOCH", "B_Heli_Transport_03_unarmed_EPOCH"];
	IL_Supported_Vehicles_CHINOOK = ["CH_147F", "CH_47F"];
	IL_Supported_Vehicles_MH9 = ["B_Heli_Light_01_F", "B_Heli_Light_01_EPOCH"];
	...
	IL_Supported_Hunter = ["B_MRAP_01_EPOCH", "B_MRAP_01_F", "B_MRAP_01_gmg_F", "B_MRAP_01_hmg_F", "Marinir_B_MRAP_01_FG" , "Marinir_MRAP_01_gmg_FG", "Marinir_MRAP_01_hmg_FG", "B_mas_mar_MRAP_01_med_F", "B_mas_mar_MRAP_01_F", "B_mas_mar_MRAP_01_gmg_F", "B_mas_mar_MRAP_01_hmg_F"];
	...
	IL_Supported_Quadbike = ["ebike_epoch", "K01", "K02", "K03", "K04", "I_Quadbike_01_F", "C_Quadbike_01_F", "O_Quadbike_01_F", "B_G_Quadbike_01_F", "B_Quadbike_01_F", "CAF_Quadbike_OD", "CAF_Quadbike_AR", "Marinir_Quadbike_01_FG", "B_mas_mar_Quadbike_01_F", "C_Quadbike_01_EPOCH"];
	IL_Supported_Supply_Crate = ["GroundWeaponHolder", "CargoNet_01_box_F", "Box_East_AmmoVeh_F", "ContainerSupply", "GroundWeaponHolder", "B_supplyCrate_F", "IG_supplyCrate_F", "O_supplyCrate_F", "I_supplyCrate_F", "C_supplyCrate_F"];
	IL_Supported_Veh_Ammo = ["GroundWeaponHolder", "CargoNet_01_box_F", "Box_East_AmmoVeh_F", "ContainerSupply", "GroundWeaponHolder", "Box_NATO_AmmoVeh_F", "Box_East_AmmoVeh_F", "Box_IND_AmmoVeh_F", "Land_CargoBox_V1_F", "ASC_B_box"];
	...
	IL_Supported_Rubberboat = ["jetski_epoch", "C_Boat_Civil_01_rescue_EPOCH", "C_Boat_Civil_01_police_EPOCH", "C_Boat_Civil_01_EPOCH", "C_Rubberboat_EPOCH", "C_Rubberboat_02_EPOCH", "C_Rubberboat_03_EPOCH", "C_Rubberboat_04_EPOCH", "I_Boat_Transport_01_F", "O_Boat_Transport_01_F", "B_G_Boat_Transport_01_F", "B_Boat_Transport_01_F", "C_Rubberboat", "O_Lifeboat", "B_Lifeboat", "Marinir_duck_base_F", "B_mas_mar_Boat_Transport_01_F"];
	IL_Supported_SDV = ["B_SDV_01_EPOCH", "I_SDV_01_F", "O_SDV_01_F", "B_SDV_01_F", "B_mas_mar_SDV_01_F"];
	IL_Supported_Box_H1 = ["GroundWeaponHolder", "CargoNet_01_box_F", "Box_East_AmmoVeh_F", "ContainerSupply", "GroundWeaponHolder", "Box_East_Wps_F", "Box_IND_Wps_F", "Box_East_WpsLaunch_F", "Box_NATO_WpsLaunch_F", "Box_IND_WpsLaunch_F", "Box_IND_WpsSpecial_F", "Box_East_WpsSpecial_F", "Box_NATO_WpsSpecial_F", "Box_mas_all_rifle_Wps_F", "Box_mas_us_rifle_Wps_F", "Box_mas_ru_rifle_Wps_F", "Box_mas_mar_NATO_equip_F", "Box_mas_mar_NATO_Wps_F"];
	IL_Supported_Box_H2 = ["GroundWeaponHolder", "CargoNet_01_box_F", "Box_East_AmmoVeh_F", "ContainerSupply", "GroundWeaponHolder", "Box_NATO_AmmoOrd_F", "Box_East_AmmoOrd_F", "Box_IND_AmmoOrd_F", "Box_NATO_Grenades_F", "Box_East_Grenades_F", "Box_IND_Grenades_F", "Box_NATO_Ammo_F", "Box_East_Ammo_F", "Box_IND_Ammo_F", "Box_IND_Support_F", "Box_East_Support_F", "Box_NATO_Support_F"];
	...
	IL_Supported_Cargo_Veh_Offroad = IL_Supported_Quadbike + IL_Supported_Rubberboat;
	...
	IL_Supported_Cargo_Veh_VAN = IL_Supported_Quadbike + IL_Supported_Rubberboat;
	...
	IL_Supported_Cargo_Veh_Kamaz = IL_Supported_Quadbike + IL_Supported_Rubberboat + IL_Supported_SDV + IL_Supported_Hatchback;
	...
	IL_Supported_Cargo_Veh_HEMTT = IL_Supported_Quadbike + IL_Supported_Rubberboat + IL_Supported_SDV + IL_Supported_Hatchback + IL_Supported_VAN + IL_Supported_OFFROAD + IL_Supported_SUV;
	...
	IL_Supported_Cargo_Veh_TEMPEST = IL_Supported_Quadbike + IL_Supported_Rubberboat + IL_Supported_SDV + IL_Supported_Hatchback + IL_Supported_VAN + IL_Supported_OFFROAD + IL_Supported_SUV;
	...
	IL_Supported_Cargo_Veh_Mohawk = IL_Supported_Quadbike + IL_Supported_Rubberboat + IL_Supported_SDV + IL_Supported_Hatchback + IL_Supported_UGV + IL_Supported_VAN + IL_Supported_OFFROAD + IL_Supported_SUV;
	...
	IL_Supported_Cargo_Veh_CHINOOK = IL_Supported_Quadbike + IL_Supported_Rubberboat + IL_Supported_SDV + IL_Supported_Hatchback + IL_Supported_UGV + IL_Supported_VAN + IL_Supported_OFFROAD + IL_Supported_SUV + IL_Supported_KAMAZ;
