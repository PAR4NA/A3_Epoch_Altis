...
_object addItemCargoGlobal ["KitWoodFloor",20];
_object addItemCargoGlobal ["KitCinderWall",20];
_object addItemCargoGlobal ["KitStudWall",30];
_object addItemCargoGlobal ["ItemCorrugated",30];
_object addItemCargoGlobal ["KitFoundation",12];
_object addItemCargoGlobal ["CircuitParts",8];
_object addItemCargoGlobal ["CinderBlocks",40];
_object addItemCargoGlobal ["MortarBucket",20];
_object addItemCargoGlobal ["ItemCorrugatedLg",12];
_object addItemCargoGlobal ["EnergyPackLg",5];
_object addItemCargoGlobal ["PartPlankPack",30];
_object addItemCargoGlobal ["KitShelf",5];
